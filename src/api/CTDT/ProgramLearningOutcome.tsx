...
export const ProgramLearningOutcomeCTDTAPI = {
    LoadSelectProgramLearningOutcome: (data: { Id_Program: number }) =>
        axiosClient.post(`/ctdt/program-learning-outcome/load-option-plo`, data, {
    ...
    GetListProgramLearningOutcome: (data: { Id_Program: number, id_key_semester: number,Page: number; PageSize: number, searchTerm: string }) =>
        axiosClient.post(`/ctdt/program-learning-outcome/load-danh-sach-chuan-dau-ra-ctdt`, data, {
            headers: { "Content-Type": "application/json" },
            withCredentials: true,
        }).then((res) => res.data),
    AddProgramLearningOutcome: (data: { code: string, Description: string, Id_Program: number , order_index: number, id_key_semester: number }) =>
        axiosClient.post(`/ctdt/program-learning-outcome/them-moi-chuan-dau-ra-ctdt`, data, {
            headers: { "Content-Type": "application/json" },
            withCredentials: true,
        }).then((res) => res.data),
    InfoProgramLearningOutcome: (data: { Id_Plo: number }) =>
        axiosClient.post(`/ctdt/program-learning-outcome/info-chuan-dau-ra-ctdt`, data, {
            headers: { "Content-Type": "application/json" },
            withCredentials: true,
        }).then((res) => res.data),
    UpdateProgramLearningOutcome: (data: { Id_Plo: number, Code: string, Description: string, Id_Program: number ,order_index: number}) =>
        axiosClient.post(`/ctdt/program-learning-outcome/update-chuan-dau-ra-ctdt`, data, {
            headers: { "Content-Type": "application/json" },
            withCredentials: true,
        }).then((res) => res.data),
    DeleteProgramLearningOutcome: (data: { Id_Plo: number }) =>
        axiosClient.post(`/ctdt/program-learning-outcome/xoa-du-lieu-chuan-dau-ra-ctdt`, data, {
            headers: { "Content-Type": "application/json" },
            withCredentials: true,
        }).then((res) => res.data),
    ...
    LoadListPerformanceIndicators: (data: { id_Plo: number }) =>
        axiosClient.post(`/ctdt/program-learning-outcome/load-pi-thuoc-plo`, data, {
            headers: { "Content-Type": "application/json" },
            withCredentials: true,
        }).then((res) => res.data),
    AddPerformanceIndicators: (data: { id_Plo: number, code_pi: string, description_pi: string, order_index_pi: number }) => {
        ...
        return axiosClient.post(`/ctdt/program-learning-outcome/them-moi-pi-thuoc-plo`, formatFormData, {
            headers: { "Content-Type": "application/json" },
            withCredentials: true,
        }).then((res) => res.data);
    },  
    InfoPerformanceIndicators: (data: { id_PI: number }) =>
        axiosClient.post(`/ctdt/program-learning-outcome/thong-tin-pi-thuoc-plo`, data, {
            headers: { "Content-Type": "application/json" },
            withCredentials: true,
        }).then((res) => res.data),
    UpdatePerformanceIndicators: (data: { id_PI: number, code_pi: string, description_pi: string, order_index_pi: number }) => {
        ...
        return axiosClient.post(`/ctdt/program-learning-outcome/cap-nhat-pi-thuoc-plo`, formatFormData, {
            headers: { "Content-Type": "application/json" },
            withCredentials: true,
        }).then((res) => res.data);
    },
    DeletePerformanceIndicators: (data: { id_PI: number }) =>
        axiosClient.post(`/ctdt/program-learning-outcome/xoa-du-lieu-pi-thuoc-plo`, data, {
            headers: { "Content-Type": "application/json" },
            withCredentials: true,
        }).then((res) => res.data),
}